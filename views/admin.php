...
<form id="flow_flow_form" method="post" action="<?php echo $context['form-action']; ?>" enctype="multipart/form-data">
	<script id="flow_flow_script">
		...
		var plugin_url = '<?php echo $context['plugin_url'] . $context['plugin_dir_name'] ; ?>';
	...
	<div class="wrapper">
		<?php
			echo '<h2>'. $context['admin_page_title'] . ' v. ' . $context['version'] . ' Lite <a href="http://' . ( strpos($context['admin_page_title'], 'Stack') !== false ? 'stack.looks-awesome.com/docs/Getting_Started' : 'docs.social-streams.com' )  . '" target="_blank">Documentation & FAQ</a></h2>';
			echo '<div id="ff-cats">';
