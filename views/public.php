	...
	<script type="text/javascript">
		...
		(function ( $ ) {
			...
			if (FF_resource.scriptDeferred.state() === 'pending' && !FF_resource.scriptLoading) {
				...
				script.src = "<?php echo $context['plugin_url'] . $context['plugin_dir_name'];?>/js/public.js";
			...
			if (FF_resource.styleDeferred.state() === 'pending' && !FF_resource.styleLoading) {
				...
				style.href = "<?php echo $context['plugin_url'] . $context['plugin_dir_name'];?>/css/public.css";
				style.media = "screen";
