...
Looking for other sources like other social networks, WordPress posts and RSS? More sources and tons of fantastic features are available in PRO version! [Check out comparison table](http://www.social-streams.com#pricing "Flow-Flow Pricing")

= PRO version features =
* More sources to stream. In total 14 networks including Google+, YouTube, LinkedIn, Tumblr, Soundcloud, Vine, Dribbble, Flickr and others + WordPress posts and RSS feeds. [Full list of sources](http://social-streams.com/#socialfeeds "Flow-Flow Social Feeds")
...
Upgrade to PRO! [Check out comparison table](http://www.social-streams.com#pricing "Flow-Flow Pricing")
...
In the search field type "Flow-Flow"Â and click Search Plugins. Once you have found it you can install it by simply clicking "Install Now".
...
Settings are located in WP Admin on first-level, look for Flow-Flow menu item.
