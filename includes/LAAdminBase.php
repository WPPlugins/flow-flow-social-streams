...
//		add_filter( 'plugin_action_links_' . $plugin_basename, array( $this, 'add_action_links' ) );
		add_filter( 'plugin_action_links_flow-flow-social-streams/flow-flow.php', array( $this, 'add_action_links' ) );
	}
	...
	public final function enqueue_admin_scripts() {
		$pl_name = $this->context['plugin_dir_name'];
		$plugin_directory = plugins_url() . '/' . $pl_name . '/';
