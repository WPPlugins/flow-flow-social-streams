				...
				<div class="section" id="streams-list-section">
					...
					<table>
						...
						<tr>
							...
							<th>Feeds</th>
							<?php
							echo '<th>Status</th><th>Shortcode</th>';
							?>
						</tr>
						</thead>
						<tbody>
						...
						foreach ($arr as $stream) {
							...
							$additionalInfo = '<td><span class="cache-status-'. $status .'"></span></td><td><span class="shortcode">[ff id="' . $id . '"]</span><span class="shortcode-copy">Copy</span></td>';
